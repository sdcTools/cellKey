...
#' are shown:
#' \itemize{
#' \item \code{UWC_{vname}}: unweighted counts for variable specified
#' in \code{vname}
...
#' \item \code{WCavg_{vname}}: average cell weight for variable specified in
#' \code{vname}
#' \item \code{row_indices}: row index in respect to the perturbation table used
#' \item \code{col_indices}: column index in respect to the perturbation table
#' used. This value is always \code{NA} in case "destatis"-type lookup tables
#' have been used.
#' \item \code{pert}: actual amount of perturbation \code{vname}
#' \item \code{cellKey}: actual cellKey used in the lookup-procedure
#' \code{vname}
#' }
